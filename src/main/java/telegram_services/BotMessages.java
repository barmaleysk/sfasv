...
public enum  BotMessages {
    ...
    ONE_MONTH("Стоимость подписки на 1 месяц = $600" +
            "\nНажмите \"Оплатить\", чтобы перейти к оплате  на сайте Advcash"),
    TWO_MONTH("Стоимость подписки на 2 месяца = $800"
            +"\nНажмите \"Оплатить\", чтобы перейти к оплате  на сайте Advcash"),
    THREE_MONTH("Стоимость подписки на 3 месяца  = $1000"
            +"\nНажмите \"Оплатить\", чтобы перейти к оплате  на сайте Advcash"),
    UNLIMIT_SUBSCRIPTION("Стоимость безлимитной подписки = $10000"
            +"\nНажмите \"Оплатить\", чтобы перейти к оплате  на сайте Advcash"),
